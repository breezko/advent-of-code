...
def _mult(items: tuple) -> int:
    ...
    Args:
        items (tuple): values to mulitply
...
def adv1(puzzle: list, comb: int) -> int:
    """find the entries (puzzle) that sum to 2020 and then multiply those numbers (comb) together.

    Args:
        puzzle (list): input list
        comb (int): amount of combinations e.g 2 or 3
